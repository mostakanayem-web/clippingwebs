...
export default function ColorCorrection() {
    ...
    const faqData = [
        {
            question: "What Is Color Correction Service?",
            answer: "Color correction is the process of adjusting and enhancing the colors in an image to make them look more natural, accurate, and appealing. This involves fixing white balance, exposure, contrast, saturation, and other color properties to ensure your images look professional and true-to-life."
        },
        {
            question: "What Does Color Correction Do?",
            answer: "Color correction allows you to:\n- Fix unwanted color casts and lighting issues\n- Ensure consistent colors across product images\n- Match brand colors and specifications\n- Enhance product appeal and vibrancy\n- Prepare images for different platforms (web, print, mobile)\n- Create a cohesive visual identity for your catalog"
        },
        {
            question: "Why Is Color Correction Service Necessary?",
            answer: "Color correction service is necessary for:\n- Accurate product representation in e-commerce\n- Building customer trust with true-to-life colors\n- Reducing product returns due to color mismatches\n- Creating consistent brand imagery\n- Professional marketing materials\n- Meeting color standards across platforms\n- Achieving pixel-perfect color accuracy"
        },
        {
            question: "How Do I Select The Best Color Correction Service?",
            answer: "When selecting a color correction service, consider:\n- Quality of previous work and color accuracy\n- Ability to match color references and swatches\n- Experience with your product type\n- Turnaround time for large projects\n- Pricing structure and bulk discounts\n- Color profiling and consistency capabilities\n- Revision policy and satisfaction guarantee\n- Support for different output formats and platforms"
        },
        {
            question: "What Are The Types of Color Correction?",
            answer: "There are several types of color correction:\n- Basic Color Correction: White balance, exposure, and contrast fixes\n- Advanced Color Grading: Creative color adjustments for mood and style\n- Color Matching: Matching specific color references or swatches\n- Product Recoloring: Creating different color variants from one image\n- Batch Color Correction: Consistent color treatment across multiple images\n- Platform-Specific Correction: Optimizing colors for different online platforms"
        }
    ];
    ...
    return (
        <Layout>
            <Head>
                <title>Color Correction Services | Clipping Webs</title>
                <meta name="description" content="Professional color correction services for e-commerce. Perfect white balance, exposure correction, and color grading. Free trial available." />
                <meta name="keywords" content="color correction, color grading, white balance, exposure correction, product photo editing, e-commerce photo editing" />

                {/* Canonical URL */}
                <link rel="canonical" href="https://clippingwebs.com/services/color-correction" />

                {/* Open Graph */}
                <meta property="og:title" content="Color Correction Services | Clipping Webs" />
                <meta property="og:description" content="Professional color correction services for e-commerce. Perfect white balance, exposure correction, and color grading. Free trial available." />
                <meta property="og:url" content="https://clippingwebs.com/services/color-correction" />
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            "description": "Professional color correction services for e-commerce. Perfect white balance, exposure correction, and color grading with free trial available.",
                            ...
                            "hasOfferCatalog": {
                                "@type": "OfferCatalog",
                                "name": "Color Correction Packages",
                                "itemListElement": [
                                    {
                                        "@type": "Offer",
                                        "itemOffered": {
            ...
            {/* Hero Section */}
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden" id="color-correction-hero">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center min-h-screen">
                        ...
                        <div className="text-center relative z-10 py-12 animate-fade-in-up">
                            ...
                            <p className="text-xl md:text-2xl text-gray-700 mb-8 font-raleway font-semibold animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                                Perfect Colors for Perfect Products
                            </p>
                            ...
                            <div className="mt-8 flex justify-center space-x-6 stagger-animation">
                                <div className="text-center hover-lift group animate-fade-in-up">
                                    ...
                                    <p className="text-sm font-medium text-gray-700 font-raleway">Perfect Colors</p>
                                </div>
                                <div className="text-center hover-lift group animate-fade-in-up">
                                    ...
                                    <p className="text-sm font-medium text-gray-700 font-raleway">White Balance</p>
                                </div>
                                <div className="text-center hover-lift group animate-fade-in-up">
                                    ...
                                    <p className="text-sm font-medium text-gray-700 font-raleway">Exposure Fix</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="absolute bottom-0 left-0 w-full bg-gradient-to-r from-primary/80 to-primary-hover/80 py-4 overflow-hidden z-20 backdrop-blur-sm">
                    <div className="service-ticker flex whitespace-nowrap">
                        {['Color Grading', 'White Balance', 'Exposure Fix', 'Color Matching', 'Recoloring', 'Batch Correction', 'Color Grading', 'White Balance', 'Exposure Fix', 'Color Matching', 'Recoloring', 'Batch Correction'].map((item, i) => (
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16 stagger-animation">
                        <div className="w-full lg:w-1/2 animate-slide-in-left">
                            <div className="max-w-2xl">
                                <h2 className="text-4xl lg:text-5xl font-bold text-gray-800 mb-6 leading-tight font-raleway uppercase">Professional Color Correction Services</h2>
                                <div className="space-y-6 text-gray-600 mb-8 font-raleway">
                                    <p className="text-lg leading-relaxed text-gray-600">
                                        At <span className="font-semibold text-primary">Clipping Webs</span>, we specialize in professional color correction that brings your images to life. Our expert color specialists use advanced techniques to perfect white balance, exposure, contrast, and saturation, ensuring your products look exactly as intended.
                                    </p>
                                    <p className="leading-relaxed text-gray-600">
                                        Color correction is essential for e-commerce success. Customers expect accurate color representation, and incorrect colors lead to returns and customer dissatisfaction. Our meticulous color work ensures your images accurately reflect your products while maintaining visual appeal.
                                    </p>
                                    <div className="bg-primary/5 border-l-4 border-primary pl-4 py-2 my-6">
                                        <p className="font-medium text-gray-700 italic">
                                            &quot;Accurate colors build trust, reduce returns, and increase customer satisfaction across all platforms.&quot;
                                        </p>
                                    </div>
                                    <p className="leading-relaxed text-gray-600">
                                        Whether you&apos;re preparing images for Amazon, Etsy, Shopify, or your own website, our color correction services ensure consistency, accuracy, and visual excellence across your entire catalog.
                                    </p>
                                </div>
                        ...
                        <div className="w-full lg:w-1/2 animate-slide-in-right">
                            <div className="relative h-full flex flex-col justify-center">
                                ...
                                <div className="relative rounded-3xl overflow-hidden shadow-2xl image-hover-effect mb-6 hover-lift floating-element" style={{ height: '450px' }}>
                                    <Image src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                                         alt="Color Correction Excellence" 
                                         fill
                                         className="object-cover" />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                                    <div className="absolute bottom-8 left-8 right-8">
                                        <span className="inline-block bg-primary text-white px-4 py-2 rounded-full font-raleway font-bold text-sm mb-3">Expert Color Work</span>
                                        <h3 className="text-white text-2xl font-bold font-raleway">Perfect Color Every Time</h3>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-6 border border-primary/20 hover-lift animate-fade-in-up" style={{ animationDelay: '1s' }}>
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <div className="text-3xl font-bold text-primary font-raleway mb-1">99%</div>
                                                <p className="text-sm text-gray-700 font-raleway font-medium">Color Accuracy</p>
                                            </div>
                                    ...
                                    {/* Stats Card 2 */}
                                    <div className="bg-gradient-to-br from-blue-500/10 to-blue-400/5 rounded-2xl p-6 border border-blue-400/20 hover-lift animate-fade-in-up" style={{ animationDelay: '1.2s' }}>
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <div className="text-3xl font-bold text-blue-600 font-raleway mb-1">24H</div>
                                ...
                                <div className="mt-6 bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover-lift floating-element" style={{ animationDelay: '1.4s' }}>
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <div className="font-bold text-gray-800 font-raleway">500+</div>
                                            <p className="text-sm text-gray-600 font-raleway">Successful Projects</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="py-16 bg-light-gray service-section animate-fade-in-up relative" id="service-features">
                <div className="container mx-auto px-4 relative z-10">
                    <h2 className="text-3xl font-bold text-center mb-12 font-raleway text-gray-800 uppercase">Our Color Correction Services</h2>
                    <div className="service-feature-grid">
                        {[
                            { icon: 'balance-scale', title: 'White Balance Fix', desc: "Correct color casts caused by different lighting conditions to achieve neutral, accurate whites." },
                            { icon: 'sun', title: 'Exposure Correction', desc: "Adjust brightness, contrast, and highlights for optimal visibility and professional appearance." },
                            { icon: 'wand-magic-sparkles', title: 'Color Grading', desc: "Apply artistic color adjustments and creative tones to enhance mood and align with brand identity." },
                            { icon: 'palette', title: 'Product Recoloring', desc: "Create different color variants of the same product without needing separate photoshoots." }
                        ].map((feature, idx) => (
            ...
            {/* Why Color Correction Section */}
            <section className="py-16 bg-white service-section animate-fade-in-up relative" id="why-color-correction">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="flex flex-col md:flex-row items-center gap-12 stagger-animation">
                        <div className="w-full md:w-1/2 animate-slide-in-left">
                            <h2 className="text-3xl font-bold mb-6 font-raleway text-gray-800 uppercase">Why Is Color Correction Service Necessary?</h2>
                            <h3 className="text-2xl font-bold text-primary mb-4 font-raleway">Accurate Colors, Happy Customers</h3>
                            <p className="text-medium-gray mb-6 leading-relaxed font-raleway">
                                In e-commerce, color accuracy directly impacts customer satisfaction and return rates. When products don&apos;t match their online images, customers feel deceived, leading to negative reviews and returns. Professional color correction ensures your images represent your products accurately.
                            </p>
                            <p className="text-medium-gray mb-6 leading-relaxed font-raleway">
                                At Clipping Webs, our color correction specialists understand the science of color and the art of enhancement. We adjust white balance, fix exposure issues, enhance saturation, and apply creative grading—all while maintaining accuracy and consistency across your catalog.
                            </p>
                            <p className="text-medium-gray mb-8 leading-relaxed font-raleway">
                                Our expert team delivers high-quality results on time, every time, ensuring your products look their absolute best.
                            </p>
            ...
            <section className="py-16 bg-light-gray service-section animate-fade-in-up relative" id="color-matching">
                
                <div className="container mx-auto px-4 relative z-10">
                    <div className="flex flex-col md:flex-row-reverse items-center gap-12 stagger-animation">
                        <div className="w-full md:w-1/2 animate-slide-in-right">
                            <h2 className="text-3xl font-bold mb-6 font-raleway text-gray-800 uppercase">Color Matching & Consistency</h2>
                            <h3 className="text-2xl font-bold text-primary mb-4 font-raleway">Precision Color Accuracy for Catalogs</h3>
                            <p className="text-medium-gray mb-6 leading-relaxed font-raleway">
                                Consistency is key in professional catalogs. When customers see your products across different platforms and marketing materials, the colors must match perfectly. Clipping Webs specializes in batch color correction that ensures every image in your catalog maintains consistent, accurate colors.
                            </p>
                            <p className="text-medium-gray mb-6 leading-relaxed font-raleway">
                                We can match specific color references, Pantone codes, or fabric swatches. Our color specialists analyze lighting conditions, correct for camera limitations, and apply precise adjustments to ensure color accuracy from image to image.
                            </p>
                            <p className="text-medium-gray mb-8 leading-relaxed font-raleway">
                                Whether you need subtle corrections or creative color grading, we deliver results that exceed expectations. With Clipping Webs, you get reliable, high-quality color work for every image.
                            </p>
                            <Link href="/contact" className="bg-primary text-white px-8 py-3 rounded-lg font-semibold shadow-green-glow hover:bg-primary-hover hover:shadow-green-glow-hover transition-all duration-300 btn-primary btn-animated magnetic-btn inline-block font-raleway">
                                FREE TRIAL
                            </Link>
            ...
            <section className="py-16 bg-white service-section animate-fade-in-up relative" id="benefits">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <h2 className="text-3xl font-bold text-center mb-12 font-raleway text-gray-800 uppercase">Color Correction for E-Commerce Success</h2>
                    <div className="max-w-4xl mx-auto text-center">
                        <p className="text-medium-gray mb-12 text-lg leading-relaxed font-raleway">
                            Color is one of the most important factors in e-commerce product photos. Correct colors reduce returns, build customer trust, and increase conversions. Get more sales on Amazon, Etsy, Shopify, eBay, Walmart, and other marketplaces with our professional color correction and image editing services.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                            {[
                                { title: 'Accurate Color Representation', desc: 'Ensure colors match real-life products to reduce returns and customer dissatisfaction.' },
                                { title: 'White Balance Correction', desc: 'Fix color casts and lighting issues from different shooting environments.' },
                                { title: 'Batch Color Consistency', desc: 'Apply consistent color treatment across hundreds or thousands of product images.' },
                                { title: 'Creative Color Grading', desc: 'Apply artistic color adjustments to enhance mood and align with brand identity.' }
                            ].map((benefit, idx) => (
            ...
            <section className="py-16 bg-light-gray service-section animate-fade-in-up relative" id="before-after-gallery">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <p className="text-medium-gray text-center mb-12 max-w-2xl mx-auto font-raleway leading-relaxed">
                        See how Clipping Webs transforms ordinary images into stunning visual assets with professional color correction. Explore our samples to check the quality.
                    </p>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="flex flex-col md:flex-row items-center gap-12 stagger-animation">
                        <div className="w-full md:w-1/2 animate-slide-in-left">
                            ...
                            <h3 className="text-2xl font-bold text-primary mb-4 font-raleway">Your Trusted Partner for Professional Color Correction & Image Editing</h3>
                            <p className="text-medium-gray mb-6 leading-relaxed font-raleway">
                                Choosing Clipping Webs for color correction means working with a team of color specialists who understand the importance of accuracy and consistency in e-commerce. Since 2022, we&apos;ve been trusted by global retailers, photographers, and brands to deliver perfect colors that boost sales and customer satisfaction.
                            </p>
                            <p className="text-medium-gray mb-6 leading-relaxed font-raleway">
                                Our expert approach ensures precise white balance, accurate exposure, and vibrant colors—ideal for catalogs, online stores, and marketing campaigns. With the capacity to handle bulk images and complex projects, we combine speed, affordability, and strict quality control.
                            </p>
                            <p className="text-medium-gray mb-8 leading-relaxed font-raleway">
                                At Clipping Webs, we don&apos;t just correct colors—we enhance your visual assets to strengthen your brand and increase customer confidence.
                            </p>
                        ...
                        <div className="w-full md:w-1/2 animate-slide-in-right">
                            <div className="slider-container bg-light-gray rounded-lg relative w-full h-[560px]">
                                ...
                                />
                                <div className="absolute bottom-4 left-4 bg-black bg-opacity-70 text-white px-3 py-1 rounded text-sm font-raleway z-20">
                                    Professional Color Correction Results
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-animation">
                        {[
                            ...
                            { icon: 'user-tie', title: 'Expert', desc: 'Our team consists of skilled and experienced color specialists with 8 years of expertise.' },
            ...
            <section className="py-16 bg-white service-section animate-fade-in-up relative" id="testimonials">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 stagger-animation text-left">
                        {[
                            {
                                text: '"Clipping Webs\'s color correction services have dramatically improved our product images. The colors are now accurate and consistent across our entire catalog. Our conversion rates increased significantly!"',
                                name: 'Jessica Park',
                                role: 'E-commerce Manager, Fashion Brand',
                                img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d'
                            },
                            {
                                text: '"We were struggling with inconsistent colors across our product photos. Clipping Webs fixed all of them with perfect accuracy. Quick turnaround, professional results. Highly recommended!"',
                                name: 'David Chen',
                                role: 'Operations Director, Retail Company',
                    ...
                    <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
                        <div className="md:flex">
                            <div className="md:w-1/2 bg-primary text-white p-12 flex flex-col justify-center text-left">
                                <h2 className="text-3xl font-bold mb-6 font-raleway uppercase">Get 05 Images Corrected for Free</h2>
                                <p className="mb-8 opacity-90 leading-relaxed text-lg font-raleway text-white">Experience our professional color correction services with no commitment. Send us up to 5 images and we&apos;ll correct them for free.</p>
                                <div className="space-y-5">
                                    {[
                                        'No credit card required',
                                        'Up to 5 images corrected for free',
